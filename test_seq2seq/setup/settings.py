...
package_path = os.path.realpath(os.path.dirname(__file__) + '/../tmp/')

# model path
out_dir = os.path.join(package_path, "chat_model")

# training data path
train_dir = os.path.join(package_path, "chat_data")

# raw data path (data to be prepared and tokenized)
source_dir = os.path.join(package_path, "chat_new")
